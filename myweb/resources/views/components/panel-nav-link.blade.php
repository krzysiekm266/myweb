...
<a {{ $attributes->merge(['class' =>'uppercase  font-bold bg-gray-900 w-14 h-14  rounded-full sm:w-24 sm:h-12  sm:rounded-md flex items-center justify-center p-2 mt-1 mr-1   text-wrap text-center text-xxs sm:text-xs'.$classes]) }}>
    {{ $slot }}
</a>
