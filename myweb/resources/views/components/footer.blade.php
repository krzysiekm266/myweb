<div class="w-full mt-1  h-auto sm:h-44 bg-gray-900  bottom-0 text-gray-200 items-center justify-between text-center flex sm:flex-row flex-col">
    <div class="ml-4">
        ...
        <p class="text-gray-500 text-xs font-bold uppercase mt-2">
            Created: 2021 by: krzysiekm
        </p>

    </div>
   <div class="flex flex-col ml-14 mt-1 items-baseline uppercase ">
   ...
   <div class="flex flex-col mx-8 items-baseline text-gray-500">
