...
$classes = ($active ?? false)
            ? 'inline-flex  items-center  justify-center px-2 pt-1 border-b-2 border-green-600 font-sans
                leading-5 text-green-600 focus:outline-none focus:border-green-700 transition duration-150 ease-in-out
                md:text-1xl'
            : 'inline-flex items-center   justify-center px-2 pt-1 border-b-2 border-transparent font-sans
