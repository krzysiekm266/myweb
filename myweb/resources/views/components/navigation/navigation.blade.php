...
<div class="bg-black flex flex-col  justify-center p-2 pb-0 sm:space-x-4 sm:justify-center sm:flex-row ">

    <x-navigation.navigation-button :href="route('index')" :active="request()->routeIs('index')">
        <svg  class="h-8 w-8 md:h-13 md:w-13" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <x-navigation.navigation-button :href="route('products')" :active="request()->routeIs('products')">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 md:h-13 md:w-13" fill="none" viewBox="0 0 24 24" stroke="currentColor">
