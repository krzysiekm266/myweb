...
<x-app-layout>
    ...
    <div class=" py-12 w-3/4  md:w-3/6 mx-auto p-2" >
        <div class=" mx-auto">
            <div class="bg-white  shadow-sm mx-auto  rounded-md h-auto ">
                <div class=" h-auto w-full mx-auto relative">
                    {{-- circles top left --}}
                    <div class="z-30 w-64 h-64 absolute -top-10 -left-10 rounded-full bg-gray-100 ">
                        <div class="bg-main bg-cover ring-2 ring-white z-40 w-60 h-60 rounded-full bg-white absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                    ...
                    <div >
                        ...
                        <div class=" w-56 h-52 rounded-full bg-green-500 float-left transform -translate-x-4 -translate-y-4">
                        </div>
                        {{-- text content --}}
